...
class ParticipantResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            // interview-scheduling (design AD-7, tasks T-B4): null/null means
            // "never scheduled" (today's immediate path) — the pair of
            // nullable columns carries that meaning (AD-1), not a sentinel
            // enum case. Both null together or both non-null, enforced by
            // the `participants_scheduling_status_pair_check` DB CHECK.
            'scheduled_at' => $participant->scheduled_at?->toISOString(),
            'scheduling_status' => $participant->scheduling_status?->value,
            /*
