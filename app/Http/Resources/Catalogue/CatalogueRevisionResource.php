...
{
    /**
     * @return array{id: int, state: string, is_baseline: bool, label: string|null, published_at: string|null, parent_revision_id: int|null}
     *
     * @scramble-return array{id: int, state: string, is_baseline: bool, label: string|null, published_at: string|null, parent_revision_id: int|null}
     */
