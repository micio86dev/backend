...
return [
    ...
    // Pinned false and NOT env-overridable to true by accident: this product's
    // exceptions carry candidate answers, and PII here is not a preference.
    'send_default_pii' => false,

    // Every event passes the scrubber before it leaves. send_default_pii=false
    // only stops Sentry ADDING context; it does nothing about what this
    // application's own exceptions already carry — prompt text, transcripts,
