...
return [
    ...
    'info' => [
         ...
         * API version.
         */
        // D33: API version from VERSION file — keeps openapi.json info.version in sync.
        'version' => env('API_VERSION', trim((string) @file_get_contents(base_path('VERSION'))) ?: '0.1.0'),
